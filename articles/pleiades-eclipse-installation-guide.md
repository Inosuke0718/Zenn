...
2.  **最新版「Eclipse 2025」を選択**
    ...
    ![公式サイトトップページ](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/2.1_dl-site-top-page.png?raw=true)
3.  **パッケージの選択（Java 向け）**
    ...
    ![パッケージの選択](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/2.2_select-java-in-pleiades.png?raw=true)
    ![ダウンロードリンク](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/2.3_click-dl-link-in-pleiades.png?raw=true)
...
1.  ダウンロードした exe ファイルを実行。
    ...
    ![ダウンロードしたファイル](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/3.1_downloaded-file.png?raw=true)
...
> Pleiades は安全なソフトですので、 **「詳細情報」** をクリックし、 **「実行」** ボタンを押して進めてください。
    ...
    ![SmartScreen警告画面](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/3.2_avoid-unknown-publisher.png?raw=true)
    ![解凍中の画面](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/3.3_installing.png?raw=true)
...
1.  **実行ファイルを開く**
    ...
    ![Eclipseの起動ファイル](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/4.1_eclipse-click.png?raw=true)

2.  **ワークスペースの選択**
    「ワークスペース」とは、あなたが書いたプログラムが保存される場所のことです。
    基本的には **デフォルトのまま** で大丈夫ですので、そのまま「起動」をクリックしましょう。
    
    ![ワークスペースの選択](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/4.2_select-workspace.png?raw=true)
...
3. 【初回起動時】Microsoft Defenderの除外設定について
   ...
   ![Microsoft Defenderの警告](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/4.3_microsoft-defendercheck.png?raw=true)
...
1.  **ファイル > 新規 > Java プロジェクト** を選択。
    ...
    ![Javaプロジェクトの作成](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/5.1_java-project-creation.png?raw=true)

2.  プロジェクト名に `HelloWorldProject` と入力して「完了」。

    ![プロジェクト名入力](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/5.2-java-hello-world-project.png?raw=true)
### STEP 2: クラスの作成

1.  左側の「パッケージ・エクスプローラー」から `src` フォルダを右クリック。
2.  **新規 > クラス** を選択。
    
    ![クラスの作成](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/5.3_java-class-creation.png?raw=true)

3.  名前に `Main` と入力し、 **「public static void main(String[] args)」** にチェックを入れて「完了」。
    
    ![クラスの設定](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/5.4_java-class-creation.png?raw=true)
...
![コードの記述](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/5.5_java-class-creation.png?raw=true)

書けたら、上部にある **緑色の再生ボタン ▶** をクリック！
下の「コンソール」タブに `Hello World!` と表示されれば成功です！🎉

![コンソールの実行結果](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/5.6_java-class-creation.png?raw=true)
...
![ブレークポイントの設定](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/6.1_debug.png?raw=true)
...
![パースペクティブ切り替え](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/6.2_debug.png?raw=true)
...
![変数の確認](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/6.3_debug.png?raw=true)
...
![Java画面に戻る](https://github.com/Inosuke0718/Zenn/blob/main/images/eclipse-install/6.4_debug.png?raw=true)
