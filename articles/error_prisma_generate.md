---
title: "npx prisma generate実行時に発生するエラー"EPERM: operation not permitted, unlink"の 解決方法"
...
# npx prisma generate実行時に発生するエラー"EPERM: operation not permitted, unlink"の 解決方法
