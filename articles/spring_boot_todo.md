...
1. **Bootstrap Grid System**を使用

   - xs, sm, md, lg ブレークポイントの活用
   - カラムの自動調整
...
1. プロジェクトルートで `./mvnw spring-boot:run` を実行
2. ブラウザで `http://localhost:8080` にアクセス

## サンプルコードとデモ

完全な実装コードは以下のリポジトリで公開しています：

**🔗 GitHub リポジトリ**: https://github.com/Inosuke0718/todo_demo
